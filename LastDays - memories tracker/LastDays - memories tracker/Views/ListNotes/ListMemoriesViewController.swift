//
//  ListMemoriesViewController.swift
...
class ListNotesViewController: UIViewController {
    ...
    private func goToEditNote(_ note: Note) {
        let controller = storyboard?.instantiateViewController(identifier: EditMemoriesViewController.identifier) as! EditMemoriesViewController
...
extension ListNotesViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: ListMemoriesTableViewCell.identifier) as! ListMemoriesTableViewCell
